    ...
    <section className="w-full">
      <div className="flex flex-col text-center w-full mb-10">
        ...
        <p className="text-muted-foreground text-sm">
          Manage shift planning like a boss!
        </p>
      </div>
      ...
      <footer className="mt-6">
        <p className="text-xs text-center text-[#64748b]">
          If you continue, you agree with our{" "}
          <Link href="/terms" target="_blank" className="text-brand-2">
            Terms
          </Link>{" "}
          and{" "}
          <Link href="/privacy" target="_blank" className="text-brand-2">
            Privacy Policy
          </Link>
        </p>
      </footer>
